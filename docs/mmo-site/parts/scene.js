...
(function(){
  ...
  /* ═══ 카드 열두 장 = 노션 실측 보고서 열두 편 ═══
     ...
     닫혔을 때 나머지 열한 편이 있는 목록에 떨어지기 때문이다. 설계 문서는 여덟 편이 이미
  ...
  const PINS=[
    ...
    /* 여섯 장이 여기 선다 — ①②(송신을 게임 스레드가 하던 시절) · ⑥⑨(브로드캐스트 복사) ·
       ⑧(팬아웃) · ⑪(코어 격리). 이 페이지의 결론('병목은 게임 루프 단일 코어')이 자리 하나에
       모여 그림으로 보인다. ①② 를 여기로 옮긴 사연은 위 EXPS 의 ① 주석에 있다. */
